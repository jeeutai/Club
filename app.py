...
def get_user_tabs(role):
    ...
    if role == "선생님":
        ...
        return base_tabs + ["📝 과제", "🧠 퀴즈", "🗳️ 투표", "📅 출석", "🔔 알림", "🔍 검색", "📄 보고서", "📊 관리", "⚙️ 설정"]
    elif role in ["회장", "부회장"]:
        #return base_tabs + ["📝 과제", "🧠 퀴즈", "🗳️ 투표", "🖼️ 갤러리", "📅 출석", "🔔 알림", "🔍 검색", "📄 보고서", "👥 관리"]
        return base_tabs + ["📝 과제", "🧠 퀴즈", "🗳️ 투표", "📅 출석", "🔔 알림", "🔍 검색", "📄 보고서", "👥 관리"]
    elif role in ["총무", "기록부장", "디자인담당"]:
        #return base_tabs + ["📝 과제", "🧠 퀴즈", "🗳️ 투표", "🖼️ 갤러리", "📅 출석", "🔔 알림", "🔍 검색", "🎯 전문"]
        return base_tabs + ["📝 과제", "🧠 퀴즈", "🗳️ 투표", "📅 출석", "🔔 알림", "🔍 검색", "🎯 전문"]
    else:
        #return base_tabs + ["📝 과제", "🧠 퀴즈", "🗳️ 투표", "🖼️ 갤러리", "📅 출석", "🔔 알림", "🔍 검색", "👤 마이페이지"]
        return base_tabs + ["📝 과제", "🧠 퀴즈", "🗳️ 투표", "📅 출석", "🔔 알림", "🔍 검색", "👤 마이페이지"]
